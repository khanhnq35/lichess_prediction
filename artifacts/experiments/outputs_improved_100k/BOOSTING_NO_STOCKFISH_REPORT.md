...
- `white_win_before`: `xgboost_conservative_before_history`
...
- `outputs_improved_100k/experiment_results.csv`
- `outputs_improved_100k/best_config.json`
- `outputs_improved_100k/metrics.json`
